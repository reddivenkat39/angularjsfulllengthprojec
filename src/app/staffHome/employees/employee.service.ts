...
export class EmployeeService {
  ...
  getAllEmployeeDetails(){
    ...
    return this.http.get("/tep/getemployeepersonalinfo",{headers: headersSend}).map(
      (res:Response)=> {
  ...
  getDetailedViewEachEmployee(empId){
    ...
    return this.http.post("/tep/getemployeepersonalbyid",candBody,{headers: headersSend}).map(
      (res:Response)=> {

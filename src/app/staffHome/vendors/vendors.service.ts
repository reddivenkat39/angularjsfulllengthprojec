...
export class VendorsService {
  ...
  getVendorEmployeesByVendId(vendorId) {
    ...
    return this.http.post("http://localhost:8080//getallemployeesbyvendorid",bodySend,{headers: headersSend}).map(
      (res:Response)=> {
  ...
  getEmployeeInvoicesById(empId){
    ...
    console.log(bodySend);
    return this.http.post("http://localhost:8080//allinvoicesbyempid",bodySend,{headers: headersSend}).map(
      (res:Response)=> {
  ...
  getAllContactsByVendorId(vendorID){
    ...
    const bodySend = {venId:vendorID};
    console.log(bodySend);
    return this.http.post("http://localhost:8080//vendorinfobyid",bodySend,{headers: headersSend}).map(
      (res:Response)=> {
